...
Dieses Dokument beschreibt das Lightweight User Datagram Protokoll (UDP-Lite), welches eine Erweitung von UDP (RFC 768) darstellt. Es wird besonderer Bezug auf die Vorteile genommen, die UDP-Lite gegenüber UDP hat. Des Weiteren findet eine Einordnung in das ISO OSI-Referenzmodell statt und es werden die Auswirkungen beschrieben, die das Protokoll auf andere OSI-Schichten haben kann.
...
Im RFC werden folgende Codecs als Beispiele genannt, welche mit UDP-Lite
