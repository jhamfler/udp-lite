...
\category{Ausarbeitung}{Lehrveranstaltung Protokolle}{RFC-Protokolle}
...
UDP, welches im RFC 768 beschrieben ist wurde jahrelang als verbindungsloses Protokoll verwendet
...
Zusätzlich müssen UDP-Lite Pakete, die eine gößere Prüfsummenlänge als
der IP-Header annehmen, ebenfalls verworfen werden. Wäre dies nicht der Fall,
könnte die Länge des UDP-Lite-Pakets nict festgestellt werden.\\
